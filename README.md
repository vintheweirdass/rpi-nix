...
<br>Ex. EEPROM, Device tree, and .elf file that is closed source (related to the first question)<br>I mean, the files are always provided by that repository, but the implementation sadly ALWAYS changes every updated
